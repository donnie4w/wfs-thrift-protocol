...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  WfsAck Rename(string path, string newpath)")
	fmt.Fprintln(os.Stderr, "  WfsAck Auth(WfsAuth wa)")
	fmt.Fprintln(os.Stderr, "  WfsData Get(string path)")
